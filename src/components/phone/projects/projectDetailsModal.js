...
const ProjectDetailsModal = ({ visible, closeModal, closeAllModals,project}) => {
    ...
    return (
        <>
          {
            show ? (
              <div className="fixed inset-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-hidden z-50 outline-none focus:outline-none bg-gray-800 w-[100%] h-full overflow-y-auto h-full rounded-md">
            ...
            <div className='flex flex-col p-4 h-full overflow-y-auto'>
              ...
              <div className='flex flex-row justify-between items-center overflow-x-auto custom-scrollbar w-full'>
                <div className='flex flex-col p-6 pl-0 justify-center items-center'>
              ...
              <div className='flex flex-col p-0 pt-0'>
